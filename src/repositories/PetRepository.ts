import IntefacePetRepository from './interfaces/InterfacePetRepository';
import PetEntity from '../entities/PetEntity';
import { Repository } from 'typeorm';
import AdotanteEntity from '../entities/AdotanteEntity';

export default class PetRepository implements IntefacePetRepository {
